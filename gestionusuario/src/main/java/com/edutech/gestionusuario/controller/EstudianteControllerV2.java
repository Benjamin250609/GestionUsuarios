...
import com.edutech.gestionusuario.Assembler.EstudianteModelAssembler;
...
@Tag(name = "EstudiantesV2", description = "API de gestión de estudiantes")
public class EstudianteControllerV2 {
    ...
    @GetMapping
    public ResponseEntity<CollectionModel<EntityModel<Estudiante>>> ListarEstudiantes() {
        ...
        List<EntityModel<Estudiante>> estudiantesModel = estudiantes.stream()
                .map(assembler::toModel)
                .toList();

        return ResponseEntity.ok(
                CollectionModel.of(estudiantesModel,
    ...
    @GetMapping("/{run}")
    public ResponseEntity<EntityModel<Estudiante>> EstudiantePorRun(
